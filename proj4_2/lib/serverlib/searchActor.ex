defmodule SearchActor do
    ...
    def handle_cast({:querySubscriberTweet, name, clientPID}, state) do
        ...
        send clientPID, {:querySubscriberTweet_result, tweets}
        {:noreply, state}
    end
    ...
    def handle_cast({:queryHashTagTweet, name, clientPID, hashTag}, state) do        
        ...
        IO.inspect(tagTweets)

        send clientPID, {:queryHashTagTweet_result, tagTweets}
        {:noreply, state}
    end
    ...
    def handle_cast({:queryMentionTweet, name, clientPID}, state) do
        ...
        send clientPID, {:queryMentionTweet_result, mentionTweets}
        {:noreply, state}
    end
end